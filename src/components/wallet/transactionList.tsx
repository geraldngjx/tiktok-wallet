            ...
            <Tabs defaultValue="transactionsHistory" className="overflow-y-hidden">
                ...
                <TabsContent value="assets" className="h-full w-full text-white overflow-y-hidden">
                    <div className="flex flex-col space-y-1 w-full">
                        <div className="p-4 bg-neutral-500/20 rounded-md text-white flex justify-between w-full items-center overflow-hidden h-20">
                            <div className="bg-black h-full aspect-square flex rounded-full items-center justify-center">
                                <Image src="/solana.svg" width={25} height={25} alt="Solana" />
                            </div>
                        ...
                        <div className="p-4 bg-neutral-500/20 rounded-md text-white flex justify-between w-full items-center overflow-hidden h-20">
                            ...
                            {usdcBalance && <span>{usdcBalance} USDC</span>}
                        </div>
                        ...
                        <div className="p-4 bg-neutral-500/20 rounded-md text-white flex justify-between w-full items-center overflow-hidden h-20">
                            ...
                            {eurcBalance && <span>{eurcBalance} EURC</span>}
                        </div>
                    </div>
                </TabsContent>
            </Tabs>
